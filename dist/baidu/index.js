...
module.exports = {
  ...
  toAll: opt => {
    baiduConverter(Object.assign({}, opt, {
      target: opt.baiduTarget
    }));
    alibabaConverter(Object.assign({}, opt, {
      target: opt.alibabaTarget
    }));
    toutiaoConverter(Object.assign({}, opt, {
      target: opt.toutiaoTarget
    }));
    baiduLinter(opt.source);
    alibabaLinter(opt.source);
    toutiaoLinter(opt.source);
