...
//  textarea
//  缺失属性
//  auto-focus,fixed,cursor-spacing,cursor,show-confirm-bar,selection-start,selection-end,adjust-position,aria-label
//  对应事件
//  bindfocus=>onFocus
//  bindblur=>onBlur
//  bindinput=>onInput
...
//  map
//  缺失属性
//  covers,subkey,enable-3D,show-compass,enable-overlooking,enable-zoom,enable-scroll,enable-rotate
//  对应事件
